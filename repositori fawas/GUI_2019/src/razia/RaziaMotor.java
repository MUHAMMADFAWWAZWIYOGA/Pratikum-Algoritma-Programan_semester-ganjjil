...
public class RaziaMotor extends JFrame {
	...
	public RaziaMotor() {
		...
		lblNewLabel_2.setBounds(130, 11, 176, 14);
		...
		CBSIM.setBounds(58, 94, 66, 22);
		contentPane.add(CBSIM);
		
		JLabel lblinfo = new JLabel("");
		lblinfo.setFont(new Font("Times New Roman", Font.ITALIC, 11));
		...
		btnReset.setForeground(new Color(255, 128, 128));
